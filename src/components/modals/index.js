...
const Modal = ({ open, setOpen, type, title }) => {
    ...
    const getFormType = () => {
        switch (type) {
            case 'users':
                return <UserForm setOpen={setOpen} setToast />
            case 'sections':
                return <SectionForm setOpen={setOpen} setToast />
            case 'news':
                return <NewsForm setOpen={setOpen} setToast />
            default:
                break;
        }
    }
